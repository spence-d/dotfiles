# Generated by Powerlevel10k configuration wizard on 2020-12-04 at 19:25 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    history               # example user-defined segment (see prompt_example function below)
    time                    # current time
